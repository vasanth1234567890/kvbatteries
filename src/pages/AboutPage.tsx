      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-sky-100 to-blue-100 p-12 rounded-lg">
              <div className="space-y-6">
                <div className="text-center">
                  <div className="text-5xl font-bold text-sky-600 mb-2">10+</div>
                  <p className="text-gray-700">Years of Service</p>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-sky-600 mb-2">5000+</div>
                  <p className="text-gray-700">Happy Customers</p>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-sky-600 mb-2">100%</div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-sky-50 to-blue-50 p-12 rounded-lg border border-sky-200">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-sky-50 p-12 rounded-lg border border-sky-200">
              <Zap className="text-sky-600 mb-4" size={40} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-white p-6 rounded-lg shadow-md flex items-start gap-3">
