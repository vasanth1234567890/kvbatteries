...
export default function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-sky-600 to-sky-800 text-white py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-white text-sky-600 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors"
                >
                  <Phone size={20} />
                  Call Now: 8825593963
                </button>
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-green-500 text-white px-8 py-3 rounded-lg font-bold hover:bg-green-600 transition-colors"
                >
            ...
            <div className="hidden md:flex justify-center">
              <div className="w-64 h-64 bg-white rounded-full flex items-center justify-center opacity-90">
                <Battery size={150} className="text-sky-600" />
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              >
                <div className="flex justify-center mb-4">
                  <Icon className="text-sky-600" size={40} />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-gradient-to-br from-sky-50 to-blue-50 p-8 rounded-lg border border-sky-200 text-center">
                <h3 className="text-2xl font-bold text-sky-600 mb-2">{name}</h3>
                <p className="text-gray-600">{desc}</p>
              </div>
            ))}
          </div>
            ...
            {[
              ...
              <div key={idx} className="bg-white p-8 rounded-lg shadow-md">
                <div className="flex items-start gap-4">
                  <Icon className="text-sky-600 flex-shrink-0 mt-1" size={32} />
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{title}</h3>
                    <p className="text-gray-600">{desc}</p>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <MapPin className="text-sky-600 flex-shrink-0 mt-1" size={24} />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Phone className="text-sky-600 flex-shrink-0 mt-1" size={24} />
                  <div>
              ...
              <a href="/contact" className="inline-block mt-8 bg-sky-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-sky-700 transition-colors">
                Get Directions
              </a>
            </div>
      ...
      <section className="bg-gradient-to-r from-sky-600 to-sky-800 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/contact"
              className="flex items-center justify-center gap-2 bg-sky-500 text-white px-8 py-3 rounded-lg font-bold hover:bg-sky-400 transition-colors"
            >
              Send Message
            </Link>
          </div>
